...
void	free_animation(t_game *g, t_list *start)
{
	...
	while (start)
	{
		...
		if (g && ((t_img *)temp->content)->i)
			mlx_destroy_image(g->mlx, ((t_img *)temp->content)->i);
		free(temp->content);
		free(temp);
	}
}
...
void	destroy_images(t_game *g)
{
	...
	if (g->tex.b && g->tex.b->i)
		mlx_destroy_image(g->mlx, g->tex.b->i);
	if (g->win_img.i)
		mlx_destroy_image(g->mlx, g->win_img.i);
	if (g->win_g.i)
		mlx_destroy_image(g->mlx, g->win_g.i);
	if (g->win_r.i)
		mlx_destroy_image(g->mlx, g->win_r.i);
	// if (g->scope && g->scope->i)
	// 	mlx_destroy_image(g->mlx, g->scope->i);
	if (g->win)
		mlx_destroy_window(g->mlx, g->win);
	if (g->minimap.i)
		mlx_destroy_image(g->mlx, g->minimap.i);
	// if (g->miniview.i)
